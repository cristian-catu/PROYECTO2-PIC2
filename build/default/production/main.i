...
void __attribute__((picinterrupt(("")))) isr (void){
    if(PIR1bits.RCIF){
        ...
        if (bit_envio == 1){
            CCPR_3 = map(entrada, 0, 255, 15, 75);
            CCPR2L = (uint8_t)(CCPR_3>>2);
            CCP2CONbits.DC2B0 = CCPR_3 & 0b1;
            CCP2CONbits.DC2B1 = CCPR_3>>1 & 0b1;

        }
        else if(bit_envio == 0){
            CCPR_4 = map(entrada, 0, 255, 15, 75);
            CCPR1L = (uint8_t)(CCPR_4>>2);
            CCP1CONbits.DC1B = CCPR_4 & 0b11;
        }
    }
